...
import com.venki.cryptotracker.presentation.coin_detail.components.ValueLabel
...
fun LineChart(
    ...
    Canvas(
        ...
        val xLabelLineHeight =  if (maxXLabelLineCount > 0 && maxXLabelHeight> 0) maxXLabelHeight / maxXLabelLineCount else 0
